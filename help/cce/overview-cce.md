...
<tr>
 <td>
   <a href="acrobat-content-creators.md">
    ...
    <div>
   <a href="acrobat-content-creators.md"><strong>Acrobat per gli autori di contenuti</strong></a>
    </div>
...
<tr>
   ...
   <a href="assets/GettingStartedWithAdobePortfolio.pdf"><strong>Guida Introduttiva Di Adobe Portfolio (PDF)</strong></a>
    ...
    <em>Condividere il lavoro migliore con Adobe Portfolio è un modo efficace per condividere il successo e attirare nuovi talenti creativi</em>
    <br>
  </td>
  <td>
  ...
  <td>
   <a href="assets/ShowYourBestWorkwithAdobePortfolio.pdf">
    ...
    <div>
   <a href="assets/ShowYourBestWorkwithAdobePortfolio.pdf"><strong>Mostra il tuo lavoro migliore con Adobe Portfolio (PDF)</strong></a>
    </div>
    <em>Adobe Portfolio ti consente di caricare, organizzare e condividere il tuo lavoro con potenziali collaboratori e clienti in tutto il mondo</em>
    <br>
  </td>
  <td>
    <img alt="Spaziatore" src="../assets/acrobat_PDF_whitespacer_96.png" />
...
<tr>
  <td>
   ...
   <a href="cc-workflows-cc-libraries.md"><strong>Migliorare i flussi di lavoro CC con CC Libraries</strong></a>
    ...
    <em>Scopri come Creative Cloud Libraries unisce gli elementi di progettazione, garantendo la coerenza del progetto per progettisti e team</em>
    <br>
  </td>
  <td>
   <a href="ccteamlibraries.md">
      <img alt="Creazione di Creative Cloud Libraries per team" src="assets/CCTeamLibraries_1280.jpg" />
   </a>
   <div>
   <a href="ccteamlibraries.md"><strong>Creazione di Creative Cloud Libraries per team</strong></a>
    </div>
    <em>Scopri come condividere le risorse in un gruppo o in un team utilizzando Creative Cloud Libraries for teams</em>
    <br>
  </td>
  <td>
  ...
  <td>
   <a href="assets/CreateAddandShareYourBrandAssetswithCreativeCloudLibraries.pdf">
    ...
    <div>
   <a href="assets/CreateAddandShareYourBrandAssetswithCreativeCloudLibraries.pdf"><strong>Crea, aggiungi e condividi le risorse del marchio con Creative Cloud Libraries (PDF)</strong></a>
    </div>
    <em>Creative Cloud Libraries fornisce un sistema di marchio integrato che consente ai designer di condividere le risorse del marchio tra team creativi</em>
    <br>
  </td>
  </tr>
  <tr>
  <td>
   <a href="assets/ShareTextStylesFromIllustratorwithCreativeCloudLibraries.pdf">
    ...
    <div>
   <a href="assets/ShareTextStylesFromIllustratorwithCreativeCloudLibraries.pdf"><strong>Condivisione di stili di testo da Illustrator con Creative Cloud Libraries (PDF)</strong></a>
    </div>
...
<tr>
 <td>
   ...
   <a href="collaboration-the-future-of-creativity.md"><strong>Collaborazione: il futuro della creatività</strong></a>
    ...
    <em>Tra i numerosi vantaggi di un abbonamento a Adobe Creative Cloud vi è l'accesso gratuito a oltre 20.000 font progettati e selezionati professionalmente da Adobe Fonts</em>
    <br>
  </td>
  <td>
  ...
  <td>
   ...
   <a href="assets/FromLightroomWebtoInDesignviaCreativeCloud.pdf"><strong>Da Lightroom Web a InDesign tramite Creative Cloud (PDF)</strong></a>
    ...
    <em>Porta la tua creatività dalla fotocamera alla progettazione finale con i file e le librerie di Creative Cloud</em>
    <br>
  </td>
  <td>
    <img alt="Spaziatore" src="../assets/acrobat_PDF_whitespacer_96.png" />
...
<td>
   <a href="taming-type-anxiety.md">
    ...
    <div>
   <a href="taming-type-anxiety.md"><strong>Ansia dei tipi di domino</strong></a>
    </div>
    <em>Scopri come accedere e utilizzare oltre 20.000 font progettati in modo professionale in Creative Cloud</em>
    <br>
  </td>
  <td>
   <a href="assets/CreatingBeautifulTypographywithCreativeCloud.pdf">
    ...
    <div>
   <a href="assets/CreatingBeautifulTypographywithCreativeCloud.pdf"><strong>Creazione di una splendida composizione tipografica con Creative Cloud (PDF)</strong></a>
    </div>
   ...
   <a href="assets/DiscoveringFontswithCreativeCloud.pdf">
    ...
    <div>
   <a href="assets/DiscoveringFontswithCreativeCloud.pdf"><strong>Individuazione dei font con Creative Cloud (PDF)</strong></a>
    </div>
    <em>La ricerca del font giusto per un progetto può sembrare a volte travolgente. Con vari servizi e app Creative Cloud, trovare il font giusto ora è divertente e stimolante</em>
    <br>
  </td>
  <td>
   ...
   <a href="assets/UnleashHiddenGemsinOpenTypefonts.pdf"><strong>Scatena gemme nascoste nei font di OpenType (PDF)</strong></a>
    ...
    <em>Il formato di OpenType consente di utilizzare un tipo di carattere con un massimo di 65.536 glifi</em>
    <br>
  </td>
</table>
...
<tr>
   ...
   <a href="assets/GettoKnowGraphicStylesinIllustrator.pdf">
    ...
    <div>
   <a href="assets/GettoKnowGraphicStylesinIllustrator.pdf"><strong>Scopri gli stili di grafica in Illustrator (PDF)</strong></a>
    </div>
    <em>Illustrator offre la possibilità di assegnare stili alla grafica in modo molto simile a quello con cui si assegna uno stile al testo</em>
    <br>
  </td>
   <td>
   ...
   <a href="assets/WorkSmarterNotHarderwithIllustrator.pdf"><strong>Lavora in modo più intelligente, non più difficile, con Adobe Illustrator CC (PDF)</strong></a>
    ...
    <em>Velocizza i tuoi disegni vettoriali in Illustrator</em>
    <br>
  </td>
  <td>
...
<tr>
  <td>
   ...
   <a href="assets/EasilyGatherandIncorporateDesignFeedbackwithAdobeAcrobatandInDesign.pdf"><strong>Raccogli e incorpora facilmente i feedback di progettazione con Adobe Acrobat e InDesign (PDF)</strong></a>
    ...
    <em>Gli stakeholder possono utilizzare Acrobat per aggiungere commenti e annotazioni dettagliati e quindi è possibile riportare rapidamente tali marcature in Adobe InDesign per visualizzarle nel contesto del layout</em>
    <br>
  </td>
  <td>
...
<tr>
  <td>
   <a href="assets/InteractivePDFGraphicalHyperlinksandNestedMasterPagesinInDesign.pdf">
    ...
    <div>
   <a href="assets/InteractivePDFGraphicalHyperlinksandNestedMasterPagesinInDesign.pdf"><strong>PDF interattivo: collegamenti ipertestuali grafici e pagine master nidificate in InDesign (PDF)</strong></a>
    </div>
...
<tr>
  <td>
    ...
    <div>
    <a href="alphabetsoup.md"><strong>Decodifica della minestra dell'alfabeto dei formati grafici</strong></a>
    </div>
    <em>I file JPG, PNG, SVG, GIF e EPS sono tutti usati comunemente nella progettazione, alcuni per pagine Web, altri per presentazioni, pubblicazioni e progetti creativi. Ma cosa significano e quale scegli?</em>
    <br>
  </td>
  <td>
  ...
  <td>
    <a href="cinemagraphps.md">
      <img alt="Creazione di immagini cinematografiche con Photoshop" src="assets/CinemagraphsPS.jpg" />
    </a>
    <div>
  ...
  <td>
    ...
    <em>Scoprite come utilizzare l'effetto Light Burst in Adobe After Effects per migliorare notevolmente una fotografia</em>
    <br>
  </td>
</tr>
<tr>
  ...
  <td>
    ...
    <div>
    <a href="assets/PhotoshopAfterEffectsAwesomenessAdobeMAX2018LabRecap.pdf"><strong>Photoshop + After Effects = Consapevolezza: Adobe MAX 2018 Lab Recap (PDF)</strong></a>
    </div>
    <em>In questo laboratorio pratico e dettagliato, combinate Photoshop con After Effects per creare immagini ed effetti sorprendenti, adatti a qualsiasi tipo di supporto</em>
    <br>
  </td>
</tr>
<tr>
  <td>
    ...
    <div>
    <a href="assets/QuicklyBrandYourInstagramPhotoswithAdobePhotoshopActions.pdf"><strong>Personalizza rapidamente con il tuo marchio le tue foto Instagram con le azioni Adobe Photoshop (PDF)</strong></a>
    </div>
  ...
  <td>
    ...
    <em>Le modifiche in Photoshop possono richiedere molto tempo, ma non devono necessariamente essere apportate</em>
    <br>
  </td>
  <td>
    ...
    <div>
    <a href="assets/AnyoneCanBeCreativewithAdobeCreativeCloud.pdf"><strong>Aggiungete un po' di Adobe Photoshop al vostro set di abilità creative (PDF)</strong></a>
    </div>
    <em>Aggiungi un po' di Adobe Photoshop al tuo set di abilità creative</em>
    <br>
  </td>
  <td>
    ...
    <em>Puoi utilizzare la schermata verde in uno studio fotografico e utilizzare After Effects per preparare l'utilizzo della foto in Photoshop</em>
    <br>
  </td>
</tr>  
</table>
