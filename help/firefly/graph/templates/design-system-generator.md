---
title: Generatore di sistemi di progettazione
description: Scoprite come generare un sistema di progettazione basato sulla schermata di un sito Web
...
# Generatore di sistemi di progettazione

Scoprite come generare un sistema di progettazione basato sulla schermata di un sito Web. Il grafico produce un insieme corrispondente di icone, pattern e componenti di layout in una singola esecuzione batch. [Aprire il generatore di sistema di progettazione](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:b40cd34c-66b2-586c-ab4a-5595490cded6).
