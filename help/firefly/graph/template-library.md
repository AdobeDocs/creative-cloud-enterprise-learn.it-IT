...
|---|---|---|
| [**Guida introduttiva - Generare un&#39;immagine**](/help/firefly/graph/templates/get-started-gen-image.md) | Grafico di base con un nodo prompt in un nodo di generazione in un unico output. | <ul><li>Hero image</li><li>Test segnaposto</li><li>Immagine di esempio</li></ul> |
| [**Generazione di caratteri coerente**](/help/firefly/graph/templates/character-gen.md) | Carica un’immagine di riferimento di un personaggio, quindi scambia la scena o il prompt della posa per ogni nuova ripresa. | <ul><li>Mascotte ricorrente</li><li>Carattere raggi</li><li>Carattere istruttore</li></ul> |
| [**Estrazione stile**](/help/firefly/graph/templates/style-extraction.md) | Inserite un’immagine di riferimento per estrarne colore, luce e texture. | <ul><li>Trasferimento look</li><li>Abbinamento look stagionale</li><li>Abbinamento di umore</li></ul> |
| [**Atmosfera al tramonto**](/help/firefly/graph/templates/sunset-vibes.md) | Crea un’immagine tipografica 3D da un prompt di testo. | <ul><li>Sovrapposizione tagline</li><li>Slogan stagionale</li><li>Flash cespite vendita</li></ul> |
...
| Modello grafico | Descrizione | Esempi di utilizzo |
|---|---|---|
| [**Aggiungere testo allo storyboard**](/help/firefly/graph/templates/text-to-storyboard.md) | Sostituite i nodi di input di testo con elementi del brano. | <ul><li>Script nello storyboard</li><li>Avvia storyboard</li><li>Storyboard di Explainer</li></ul> |
| [**Generatore storyboard**](/help/firefly/graph/templates/storyboard-builder.md) | Creare uno storyboard scena per scena, aggiungendo un nodo per battuta del commento. | <ul><li>Test della struttura narrativa</li><li>Test di stimolazione</li><li>Arco narrativo</li></ul> |
...
| Modello grafico | Descrizione | Esempi di utilizzo |
|---|---|---|
| [**Visualizzazione del marchio**](/help/firefly/graph/templates/branding-visualization.md) | Visualizza un logo o un marchio nelle scene di prodotto. | <ul><li>Visualizzazione sub-brand</li><li>Test della tavolozza</li><li>Anteprima identità</li></ul> |
...
| Modello grafico | Descrizione** | Esempi di utilizzo |
|---|---|---|
| [**Progettare il generatore di sistema**](/help/firefly/graph/templates/design-system-generator.md) | Genera un sistema di progettazione basato sulla schermata di un sito Web. | <ul><li>Set di pattern icone</li><li>Sistema del colore</li><li>Linguaggio visivo</li></ul> |
| [**Generazione di foto**](/help/firefly/graph/templates/headshots-generation.md) | Armonizzare un gruppo di foto scattate dall&#39;azienda. | <ul><li>Foto di directory</li><li>Foto di pagine del team</li><li>Cuffie professionali</li></ul> |
